    ...
    <div className={style.mainContainer}>
      ...
      <header>
        <div className=" pt-8 flex justify-around ">
          <a href="/setting/profile" className="p-3 flex items-center border w-36 rounded-full">
            <svg
          ...
          <div className="p-3 flex border w-40 rounded-full">
            <img src={units} alt="" style={{ width: "30px" }} />
            <p className="ml-1">{dataResponse?.wallet?.main_unit} Units</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
