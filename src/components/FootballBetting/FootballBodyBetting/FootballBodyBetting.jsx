...
function FootballBodyBetting() {
  return (
    <div className={style.mainContainer}>
      ...
      <div className=" fixed bottom-0 pb-2 bg-slate-800 w-auto h-16 pt-2">
        <div className="form-group flex justify-around h-12">
          <p className="w-24">ထိုးမည့်ပမာဏကိုထည့်ပါ</p>
          <input type="text" className="form-control rounded-xl mr-1 w-52 bg-slate-200" />
