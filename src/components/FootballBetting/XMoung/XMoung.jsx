...
import style from "./XMoung.module.css";
...
function XMoung() {
  ...
  useEffect(() => {
    axios
      .get(
        `${VITE_APP_DOMAIN}/api/football-fixtures?source=frontend&sortColumn=id&sortDirection=desc&limit=10&mm_football_category_id=3`,
        {
          method: "GET",
          headers: {
